...
LACKS_STRINGS_H, LACKS_STRING_H, LACKS_ERRNO_H LACKS_STDLIB_H LACKS_SCHED_H
LACKS_TIME_H  default: NOT defined unless on WIN32
...
#pragma clang diagnostic pop // ignored -Wcast-align
